...
<body>
    ...
    =========================================================-->
        <main>
                    ...
                    <div id="cbp-so-scroller" class="cbp-so-scroller ">
                        <section class="cbp-so-section first-header" style="display:none;">
                            ...
                            <figure class="cbp-so-side cbp-so-side-left">
                                <a href="#first"><img src="images/cricket.jpg" alt="img01"></a>
                            </figure>
                        </section>
                        <section class="cbp-so-section">
                            <figure class="cbp-so-side cbp-so-side-left">
                                <a href="#second"><img src="images/football.jpg" alt="img01"></a>
                            </figure>
                            <article class="cbp-so-side cbp-so-side-right">
                        ...
                        <section class="cbp-so-section">
                            ...
                            <figure class="cbp-so-side cbp-so-side-right">
                                <a href="#third"><img src="images/throw.jpg" alt="img01"></a>
                            </figure>
                        </section>
                        <section class="cbp-so-section">
                            <figure class="cbp-so-side cbp-so-side-left">
                                <a href="#fourth"><img src="images/badminton.jpg" alt="img01"></a>
                            </figure>
                            <article class="cbp-so-side cbp-so-side-right">
                                <h2 style="padding-top:20%;">19th March 2016</h2>
                            </article>
                        ...
                        <section class="cbp-so-section">
                            ...
                            <figure class="cbp-so-side cbp-so-side-right">
                                <a href="#fifth"><img src="images/basketball.jpg" alt="img01"></a>
                            </figure>
                        </section>
                        <section class="cbp-so-section">
                            <figure class="cbp-so-side cbp-so-side-left">
                                <a href="#sixth"><img src="images/table.jpg" alt="img01"></a>
                            </figure>
                            <article class="cbp-so-side cbp-so-side-right">
                                <h2 style="padding-top:20%;">19th March 2016</h2>
                            </article>
                        ...
                        <section class="cbp-so-section">
                            ...
                            <figure class="cbp-so-side cbp-so-side-right">
                                <a href="#seventh"><img src="images/chess.jpg" alt="img01"></a>
                            </figure>
                        </section>
                    </div>
                </div>
            </section>
            <section name="first" class="parallax parallax48" data-parallax-speed="-0.4">
                <div class="container">
                    <h2><em>Cricket (Super Six)</em>Men</h2>
                    <br>
                    <br>
            ...
            <section name="second" class="parallax parallax49" data-parallax-speed="-0.4">
                <div class="container">
                    <h2><em>Football (Five)</em>Men</h2>
                    <br>
                    <br>
                    <h4 style="text-align: left;font-family: 'Tangerine', serif; font-size:300%">Coordinators:<br><br>Name &nbsp;&nbsp;&nbsp;Number</h4>
                    <div class="row">
            ...
            <section name="fourth" class="parallax parallax51" data-parallax-speed="-0.4">
                <div class="container">
                    <h2><em>Badminton</em>Women</h2>
                    <br>
                    <br>
                    <h4 style="text-align: left; font-family: 'Tangerine', serif; font-size:300%">Coordinators:<br><br>Name &nbsp;&nbsp;&nbsp;Number</h4>
                    <div class="row">
            ...
            <section name="fifth" class="parallax parallax52" data-parallax-speed="-0.4">
                <div class="container">
                    <h2><em>Basketball</em>Unisex</h2>
                    <br>
                    <br>
                    <h4 style="text-align: left; font-family: 'Tangerine', serif; font-size:300%">Coordinators:<br><br>Name &nbsp;&nbsp;&nbsp;Number</h4>
                    <div class="row">
            ...
            <section name="sixth" class="parallax parallax53" data-parallax-speed="-0.4">
                <div class="container">
                    <h2><em>Table Tennis</em>Unisex</h2>
                    <br>
                    <br>
                    <h4 style="text-align: left; font-family: 'Tangerine', serif; font-size:300%">Coordinators:<br><br>Name &nbsp;&nbsp;&nbsp;Number</h4>
                    <div class="row">
            ...
            <section name="seventh" class="parallax parallax54" data-parallax-speed="-0.4">
                <div class="container">
                    <h2><em>Chess</em>Unisex</h2>
                    <br>
                    <br>
                    <h4 style="text-align: left; font-family: 'Tangerine', serif; font-size:300%">Coordinators:<br><br>Name &nbsp;&nbsp;&nbsp;Number</h4>
                    <div class="row">
