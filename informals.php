        ...
        <body class="color-1">
            <div class="cart-wrap">
                    ...
                    <div class="checkout">
                        <div class="checkout-grid">
                            <div class="checkout-grid__item">
                                <h4>T-Shirt</h4></button>
                            </div>
                            <div class="checkout-grid__item">
                                <h4>T-Shirt</h4>
                                <button class="checkout-grid__item-remove"></button>
                            </div>
                            <div class="checkout-grid__item">
                                <h4>T-Shirt </h4>
                                <button class="checkout-grid__item-remove"></button>
                ...
                <main>
                    ...
                    <section name="first" class="parallax parallax55" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="second" class="parallax parallax56" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="third" class="parallax parallax57" data-parallax-speed="-0.4">
                        <div class="container">
                            <h2><em>Run for Bucks</em>Team of 2</h2>
                            <br>
                            <br>
                            <h4 style="text-align: left; font-family: 'Tangerine', serif; font-size:300%">Coordinators:<br><br>Manvender Singh &nbsp;&nbsp;&nbsp;8428058804<br><br>Ashu Raj &nbsp;&nbsp;&nbsp;9790717809<br><br>Chirayu kamat &nbsp;&nbsp;&nbsp;9790731294<br><br>Mallika Chowdhary &nbsp;&nbsp;&nbsp;9790725006</h4>
                            <div class="row">
                                <div class="grid_6">
                                    <ul class="indents-3">
                                        <li>Description of Event:
                    ...
                    <section name="fifth" class="parallax parallax59" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="sixth" class="parallax parallax60" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="seventh" class="parallax parallax61" data-parallax-speed="-0.4">
                        <div class="container">
                                    ...
                                    <ul class="indents-3">
                                        <li>Description of Event:
                                            <p>
                                                ...
                                                <br> No offside.
                                                <br>b The match will have 2 halves with each half being 6 mins. [Subject to change].
                    ...
                    <section name="eighth" class="parallax parallax62" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="ninth" class="parallax parallax63" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="tenth" class="parallax parallax64" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="eleventh" class="parallax parallax65" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="twelvth" class="parallax parallax66" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="thirteenth" class="parallax parallax67" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="fourteenth" class="parallax parallax68" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="fifteenth" class="parallax parallax69" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="sixteenth" class="parallax parallax70" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="seventeenth" class="parallax parallax71" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="eighteenth" class="parallax parallax72" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="ninteenth" class="parallax parallax73" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="twentieth" class="parallax parallax74" data-parallax-speed="-0.4">
                        <div class="container">
                            <h2><em>JAM</em>Individual</h2>
                            <br>
                            <br>
                    ...
                    <section name="twe_first" class="parallax parallax75" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="twe_second" class="parallax parallax76" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="twe_third" class="parallax parallax77" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="twe_fourth" class="parallax parallax78" data-parallax-speed="-0.4">
                        <div class="container">
                    ...
                    <section name="twe_fifth" class="parallax parallax79" data-parallax-speed="-0.4">
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="grid_6">
                                    <p class="indents-3">Rules:
                                        <br>
                                        <li>The participants should be a group of 2 or 3 per team.</li>
                                        <br>
                                    </p>
                                </div>
                            </div>
                    ...
                    <section name="thir_one" class="parallax parallax80" data-parallax-speed="-0.4">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="grid_6">
                                    <ul class="indents-3">
                                        <li>Description of Event:
                                            <p>Think you can build a boat?
                                                <br>Think your boat can survive the high seas?
                                                <br>Come show your skill!!
                                                <br>If your ark can take on the most load you will the crowned Poseidonand you get to take home the spoils of victory!</p>
                                        </li>
                                        <li>
                                            <br>
                                        </li>
