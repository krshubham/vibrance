...
<?php
	...
	$content .= "} ";
	$content .= ".wrapper{ ";
	$content .= "background-color: #a468ed; ";
	$content .= "margin-right: 48%; ";
	$content .= "} ";
	$content .= ".bill_heading{ ";
	$content .= "margin-left: 5.2em; ";
	$content .= "font-family: 'Yesteryear', cursive; ";
	$content .= "font-size: 3em; ";
	$content .= "font-weight: 200; ";
	$content .= "margin-top: -0.5em; ";
	$content .= "margin-bottom: -1em; ";
	$content .= "} ";
	$content .= ".bill_heading1{ ";
