...
<?php
	...
	$content .= "<div style='background-color: #20202F; margin-right: 730px;'> ";
	$content .= "<header> ";
	...
	$content .= "</header> ";
	$content .= "<h1 style='margin-left: 252px;	font-size: 40px; font-weight: 200px; margin-top: -0.5px; margin-bottom: -50px; color: #E85657;' >Vibrance 2016</h1><br><br> ";
