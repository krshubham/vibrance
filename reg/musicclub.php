        ...
        <main>
            ...
            <section name="first" class="parallax parallax7" data-parallax-speed="-0.4">
                <div class="container">
                    ...
                    <br>
                    <br>
                    <h4 style="text-align: left;font-family: 'Tangerine', serif; font-size:300%">Coordinators:<br><br>Sarvansh Prasher &nbsp;&nbsp;&nbsp;9952038260<br><br>A. Sangeetha &nbsp;&nbsp;&nbsp;8754178466<br><br>Rishabh Yadav&nbsp;&nbsp;&nbsp;9453033738<br><br>Poornima Kapoor &nbsp;&nbsp;&nbsp;9999695379</h4>
                    <div class="row">
                        <div class="grid_6">
                            <ul class="indents-3">
            ...
            <section name="third" class="parallax parallax9" data-parallax-speed="-0.4">
                <div class="container">
                    ...
                    <br>
                    <br>
                    <h4 style="text-align: left; font-family: 'Tangerine', serif; font-size:300%">Coordinators:<br><br>Parthivi Gupta &nbsp;&nbsp;&nbsp;972921021<br><br>Sagorika Nandi &nbsp;&nbsp;&nbsp;8220189964<br><br>Aarushi Shonik &nbsp;&nbsp;&nbsp;9552039297<br><br>Gyanu Gautam &nbsp;&nbsp;&nbsp;07033584042</h4>
                    <div class="row">
                        <div class="grid_6">
                            <ul class="indents-3">
